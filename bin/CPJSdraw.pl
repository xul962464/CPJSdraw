...
#	warn "$draw_input[$i]->[1]->{'region'}\n";
	...
	$svg->text(x=>$sample_name_x,y=>$sample_name_y,'font-size'=>$size_of_sample_name,'font-family'=>'times new roman','font-style'=>'italic','-cdata'=>$sample_name,"text-anchor"=>"end");
	...
	$svg->text(x=>$seq_len_x,y=>$seq_len_y,'font-size'=>15,'font-family'=>'times new roman','-cdata'=>format_nu($seq_len)." bp","text-anchor"=>"end");
	...
	$svg->text(x=>$region_x->{'LSC1'}->{'start'}+$interval_of_region_name_and_junction,y=>$region_name_y,'font-size'=>$size_of_region_name,'font-family'=>'times new roman','-cdata'=>'LSC',"text-anchor"=>"start");
	$svg->text(x=>$region_x->{'LSC1'}->{'end'}+$interval_of_region_name_and_junction,y=>$region_name_y,'font-size'=>$size_of_region_name,'font-family'=>'times new roman','-cdata'=>'IRb',"text-anchor"=>"start");
	$svg->text(x=>$region_x->{'SSC'}->{'start'}+$interval_of_region_name_and_junction,y=>$region_name_y,'font-size'=>$size_of_region_name,'font-family'=>'times new roman','-cdata'=>'SSC',"text-anchor"=>"start");
	$svg->text(x=>$region_x->{'SSC'}->{'end'}+$interval_of_region_name_and_junction,y=>$region_name_y,'font-size'=>$size_of_region_name,'font-family'=>'times new roman','-cdata'=>'IRa',"text-anchor"=>"start");
	$svg->text(x=>$region_x->{'IRa'}->{'end'}+$interval_of_region_name_and_junction,y=>$region_name_y,'font-size'=>$size_of_region_name,'font-family'=>'times new roman','-cdata'=>'LSC',"text-anchor"=>"start");
	...
	$svg->text(x=>$region_x->{'LSC1'}->{'end'}-$interval_of_region_name_and_junction,y=>$region_len_y,'font-size'=>$size_of_region_len,'font-family'=>'times new roman','-cdata'=>format_nu($lsc_len)." bp","text-anchor"=>"end");
	$svg->text(x=>$region_x->{'SSC'}->{'start'}-$interval_of_region_name_and_junction,y=>$region_len_y,'font-size'=>$size_of_region_len,'font-family'=>'times new roman','-cdata'=>format_nu($irb_len)." bp","text-anchor"=>"end");
	$svg->text(x=>$region_x->{'SSC'}->{'end'}-$interval_of_region_name_and_junction,y=>$region_len_y,'font-size'=>$size_of_region_len,'font-family'=>'times new roman','-cdata'=>format_nu($ssc_len)." bp","text-anchor"=>"end");
	$svg->text(x=>$region_x->{'IRa'}->{'end'}-$interval_of_region_name_and_junction,y=>$region_len_y,'font-size'=>$size_of_region_len,'font-family'=>'times new roman','-cdata'=>format_nu($ira_len)." bp","text-anchor"=>"end");

	#junction name
	$svg->text(x=>$region_x->{'LSC1'}->{'end'},y=>$junction_name_y ,'font-size'=>$size_of_junction_name,'font-family'=>'times new roman','-cdata'=>"JLB","text-anchor"=>"middle");
	$svg->text(x=>$region_x->{'SSC'}->{'start'},y=>$junction_name_y ,'font-size'=>$size_of_junction_name,'font-family'=>'times new roman','-cdata'=>"JSB","text-anchor"=>"middle");
	$svg->text(x=>$region_x->{'SSC'}->{'end'},y=>$junction_name_y ,'font-size'=>$size_of_junction_name,'font-family'=>'times new roman','-cdata'=>"JSA","text-anchor"=>"middle");
	$svg->text(x=>$region_x->{'IRa'}->{'end'},y=>$junction_name_y ,'font-size'=>$size_of_junction_name,'font-family'=>'times new roman','-cdata'=>"JLA","text-anchor"=>"middle");
}
...
`perl $Bin/../script/svg_kit/svg2xxx.pl --type pdf $outfile`;
`perl $Bin/../script/svg_kit/svg2xxx.pl --type png --ppi $ppi $outfile`;
...
sub draw_gene_rect_and_name{
	...
	$svg->text(x=>$name_x,y=>$name_y,'font-size'=>$size_of_gene_name,'font-family'=>'times new roman','-cdata'=>$gene_name,"text-anchor"=>"middle",fill=>"white",'font-style'=>'italic');
...
sub draw_len{
	...
	$svg->text(x=>$gene_len_x,y=>$gene_len_y,'font-size'=>$size_of_gene_len,'font-family'=>'times new roman','-cdata'=>"$gene_len bp","text-anchor"=>$align,fill=>"black");
}
